...
declare module "child_process" {
    ...
    export function exec(command: string, options: {
        ...
        maxBuffer?: number;
        killSignal?: string;
    }, callback?: (error: Error, stdout: Buffer | string, stderr: Buffer | string) =>void ): ChildProcess;
    export function exec(command: string, callback?: (error: Error, stdout: Buffer | string, stderr: Buffer | string) =>void ): ChildProcess;
